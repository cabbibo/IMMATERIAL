Shader "Scenes/KelpScene/kelpBaseDebug1"
{
    Properties {
...
Tags { "RenderType"="Opaque" }
 ...
 #pragma multi_compile_fwdbase nolightmap nodirlightmap nodynlightmap novertexlight
      ...
      #include "AutoLight.cginc"
            ...
            uniform float4x4 _BodyWorldToLocal;
            ...
            v2f vert ( uint vid : SV_VertexID )
            {
                ...
                float3 fPos = mul( _BodyWorldToLocal , float4(v.pos,1));
                fPos = mul( _LocalToWorld , float4(fPos * 1,1));
                //fPos = v.pos;
